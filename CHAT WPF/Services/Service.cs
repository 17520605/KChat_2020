...
namespace CHAT_WPF.Services
{
    public class Service
    {
        public static FirebaseClient Client
        {
            ...
            {
                AuthSecret = "cXvslOyzeIZZVU8ZFt8rOE5JI5pWGqFWPYOq6q9J",
                BasePath = "https://kchat-d7f04-default-rtdb.firebaseio.com/"
            });
        }
        ...
        {
            get => new FirebaseStorage("kchat-d7f04.appspot.com");
        }
